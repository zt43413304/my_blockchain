...
scheduler.add_job(my_hashworld.loop_hashworld, "cron", hour="2,10,18", minute="30", args=["data_hashworld_Tokyo.json"], max_instances=4)
...
# scheduler.add_job(my_hashworld.loop_hashworld, "cron", minute="*/3", args=["data_hashworld_Tokyo.json"], max_instances=1)
try:
    scheduler.start()
